...
public class MyoHW {
	...
	final static int[] MYO_SERVICE_INFO_UUID = {
		0x42, 0x48, 0x12, 0x4a,     
	    0x7f, 0x2c, 0x48, 0x47,     
	    0xb9, 0xde, 0x04, 0xa9,     
	    0x01, 0x00, 0x06, 0xd5      
	};
	final static int[] kMyoServiceInfoUuid = MYO_SERVICE_INFO_UUID;

	/// The number of EMG sensors that a Myo has.
	static final int numEMGSensors = 8;
	/*/  Myo Hardware Data Structures
	/// These types and enumerations describe the format of data sent to and from a Myo device using Bluetooth Low Energy.
	/// All values are big-endian.

	/// The following int[] lists the 16bit short UUIDs of Myo services and characteristics. To construct a full 128bit
	...
	final static UUID MYO_SERVICE_BASE_UUID = UUID.nameUUIDFromBytes(new byte[]{
		0x42, 0x48, 0x12, 0x4a,    
	    0x7f, 0x2c, 0x48, 0x47,     
	    0xb9, 0xde, 0x04, 0xa9,     
	    0x00, 0x00, 0x06, 0xd5});
	...
	MYOHW_ORIENTATION_SCALE =  16384.0f, ///< See myohw_imu_data_t::orientation
	MYOHW_ACCELEROMETER_SCALE = 2048.0f,  ///< See myohw_imu_data_t::accelerometer
	MYOHW_GYROSCOPE_SCALE    = 16.0f;    ///< See myohw_imu_data_t::gyroscope
