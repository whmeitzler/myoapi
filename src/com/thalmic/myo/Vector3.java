...
public class Vector3
{
  ...
  public boolean equals(Object o)
  {
    ...
    if (Double.compare(vector.mX, this.mX) != 0) return false;
    if (Double.compare(vector.mY, this.mY) != 0) return false;
    if (Double.compare(vector.mZ, this.mZ) != 0) { return false;
    }
    return true;
  }
