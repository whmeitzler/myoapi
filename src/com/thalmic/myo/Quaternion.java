...
public class Quaternion
{
  ...
  public boolean equals(Object o)
  {
    ...
    if (Double.compare(that.mX, this.mX) != 0) return false;
    if (Double.compare(that.mY, this.mY) != 0) return false;
    if (Double.compare(that.mZ, this.mZ) != 0) return false;
    if (Double.compare(that.mW, this.mW) != 0) { return false;
    }
    return true;
  }
